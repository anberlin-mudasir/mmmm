...
<body style="margin: 5px;">
	...
	<div id="tb">
		<div>
			<a href="#" class="easyui-linkbutton" iconCls="icon-add" onclick="openGradeAddDialog()" plain="true">添加</a>
			<a href="#" class="easyui-linkbutton" iconCls="icon-edit" onclick="openGradeModifyDialog()" plain="true">修改</a>
			<a href="#" class="easyui-linkbutton" iconCls="icon-remove" onclick="deleteGrade()" plain="true">删除</a>
		</div>
		<div>&nbsp;班级名称：&nbsp;<input type="text" name="s_gradeName" id="s_gradeName"/>
		  <a href="#" class="easyui-linkbutton" iconCls="icon-search"  onclick="searchGrade()" plain="true">搜索</a></div>
	</div>
	...
	<div id="dlg-buttons">
		<a href="#" class="easyui-linkbutton" iconCls="icon-ok" onclick="saveGrade()">保存</a>
		<a href="#" class="easyui-linkbutton" iconCls="icon-cancel" onclick="closeGradeDialog()">关闭</a>
	</div>
</body>
</html>