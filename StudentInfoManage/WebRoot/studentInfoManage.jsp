...
<body style="margin: 5px;">
	...
	<div id="tb">
		<div>
			<a href="#" class="easyui-linkbutton" iconCls="icon-add" onclick="openStudentAddDialog()" plain="true">添加</a>
			<a href="#" class="easyui-linkbutton" iconCls="icon-edit" onclick="openStudentModifyDialog()" plain="true">修改</a>
			<a href="#" class="easyui-linkbutton" iconCls="icon-remove" onclick="deleteStudent()" plain="true">删除</a>
		</div>
		...
		<a href="#" class="easyui-linkbutton" iconCls="icon-search" onclick="searchStudent()" plain="true">搜索</a></div>
	</div>
	...
	<div id="dlg-buttons">
		...
		<a href="#" class="easyui-linkbutton" iconCls="icon-cancel" onclick="closeStudentDialog()">关闭</a>
	</div>
</body>
</html>